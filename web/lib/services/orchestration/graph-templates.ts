...
const DOCUMENTARY_TEMPLATE: GraphTemplate = {
  ...
  nodes: [
    ...
    { id: 'music_gen',       type: 'music_gen',       label: 'Music Generation',     dependencies: ['tts'],                 skippable: false, estimatedDurationSec: 30 },
...
const TUTORIAL_TEMPLATE: GraphTemplate = {
  ...
  nodes: [
    ...
    { id: 'mg_pass2',        type: 'mg_pass2',        label: 'MG Pass 2 (Swap)',     dependencies: ['mg_gen', 'verification'], skippable: false, estimatedDurationSec: 15 },
    { id: 'music_gen',       type: 'music_gen',       label: 'Music Generation',     dependencies: ['tts'],         skippable: false, estimatedDurationSec: 25 },
