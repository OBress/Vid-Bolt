...
const workerConfigs: WorkerConfig[] = [
  ...
  {
    queue: 'gpu-segment-image',
    processor: gpuSegmentImageProcessor,
    concurrency: 3,
    description: 'GPU image segmentation test (SAM 3)',
  },
  {
    queue: 'gpu-segment-video',
    processor: gpuSegmentVideoProcessor,
    concurrency: 2,
    description: 'GPU video segmentation/tracking test (SAM 3)',
  },
  {
    queue: 'gpu-segment-animate',
    processor: gpuSegmentAnimateProcessor,
    concurrency: 2,
    description: 'GPU animated segmentation test (SAM 3.1)',
  },
  {
