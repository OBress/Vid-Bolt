...
GRANT ALL ON FUNCTION "public"."match_stock_media"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_stock_media"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_stock_media"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."match_stock_media_for_video"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "p_user_id" "uuid", "p_video_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."match_stock_media_for_video"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "p_user_id" "uuid", "p_video_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_stock_media_for_video"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "p_user_id" "uuid", "p_video_id" "uuid") TO "service_role";
