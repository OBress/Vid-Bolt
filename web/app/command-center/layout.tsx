...
// Sidebar context for child components to control collapse state
...
export function useSidebar() {
  ...
  if (!context) {
    throw new Error("useSidebar must be used within CommandCenterLayout");
  }
  return context;
}
...
export default function CommandCenterLayout({
  ...
  const collapse = useCallback(() => setSidebarCollapsed(true), []);
  const expand = useCallback(() => setSidebarCollapsed(false), []);
