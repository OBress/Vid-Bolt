  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video w-full bg-black/40">
        ...
        {/* Multi-image badge */}
        {media?.media_items && media.media_items.length > 1 && (
          <div className="absolute bottom-2 left-2 z-10 flex items-center gap-1 px-2 py-1 rounded-md bg-black/70 backdrop-blur-sm border border-white/10">
            <Image className="w-3 h-3 text-neutral-300" />
            <span className="text-[10px] font-medium text-neutral-200">
              {media.media_items.length} images
            </span>
          </div>
        )}
