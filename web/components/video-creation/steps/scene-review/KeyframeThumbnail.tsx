...
import { Image, Plus, Loader2, AlertTriangle, Check } from "lucide-react";
 ...
 * Shows the keyframe image, generation status, or placeholder
 */
export function KeyframeThumbnail({
  ...
  const isEmpty = !imageUrl && (!status || status === "pending");
    ...
    >
      ...
      <div
        className={cn(
          ...
          hasImage ? "text-white" : "text-neutral-400",
        )}
      >
