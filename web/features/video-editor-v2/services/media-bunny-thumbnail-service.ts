...
export class MediaBunnyThumbnailService {
  ...
  static async generateThumbnail(
    ...
    try {
      ...
      // Use fixed target dimensions - we'll crop to cover
      // This ensures consistent thumbnail sizes regardless of video aspect ratio
      const thumbnailWidth = width;
      const thumbnailHeight = height;

      // Create a CanvasSink for extracting resized frames
      // Use 'cover' mode to crop and center the video to fill the target dimensions
