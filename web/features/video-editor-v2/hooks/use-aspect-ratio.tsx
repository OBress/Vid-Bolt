...
export const useAspectRatio = (
  ...
  initialResolution: ResolutionPreset = "1080p"
) => {
  ...
  /**
   * Returns the standard dimensions for the current aspect ratio and resolution.
   * @returns An object containing the width and height for the current aspect ratio
   */
  const getAspectRatioDimensions = useCallback(() => {
    return getDimensionsForAspectRatio(aspectRatio, resolution);
