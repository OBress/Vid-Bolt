...
import { MotionGraphicsLayerContent } from "./components/motion-graphics-layer-content";
...
export const LayerContent: React.FC<LayerContentProps> = ({
  ...
  switch (overlay.type) {
    ...
    case OverlayType.MOTION_GRAPHICS:
      // Motion graphics overlays render their own positioning
      return (
        <MotionGraphicsLayerContent overlay={overlay as unknown as MotionGraphicsOverlay} />
      );
