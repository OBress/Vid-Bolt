  ...
  const handleMouseMove = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
    if (!isDragging && timelineRef.current) {
      ...
      throttleRef.current = requestAnimationFrame(() => {
        ...
        // VIRTUAL SCROLL: Use the VIEWPORT container (scroll container parent) for calculations
        // The ghost marker is positioned relative to the viewport, not the content
