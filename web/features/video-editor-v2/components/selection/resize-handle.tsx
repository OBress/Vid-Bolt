...
export const ResizeHandle: React.FC<{
  ...
  const sizeStyle: React.CSSProperties = useMemo(() => {
    ...
    return {
      ...
      border: `${borderSize * 2}px solid white`,
      borderRadius: "2px",
    ...
    (e: React.MouseEvent) => {
      ...
      const onPointerMove = (pointerMoveEvent: PointerEvent) => {
        ...
        setOverlay(overlay.id, (i) => {
          ...
          // Apply snapping to the final position
          const tempOverlayForSnapping = {
            ...i,
            width: finalWidth,
            height: finalHeight,
            left: finalLeft,
          ...
          const snapPosition = alignmentGuides.calculateSnapPosition(tempOverlayForSnapping, allOverlays);
